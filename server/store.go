...
type MemoryStore struct {
	...
	invoicePayments map[string][]Payment
	invoiceEvents   map[string][]InvoiceEvent
}

func NewMemoryStore() *MemoryStore {
	s := &MemoryStore{
		appointments: map[string]Appointment{}, events: map[string][]AppointmentEvent{}, followups: map[string]Followup{},
		invoices: map[string]Invoice{}, invoiceItems: map[string][]InvoiceItem{}, invoicePayments: map[string][]Payment{}, invoiceEvents: map[string][]InvoiceEvent{},
